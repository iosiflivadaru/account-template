...
<a class="navbar-brand" href="index.php"><h3 class="text-light-blue"><?php echo $config['appName']; ?></h3></a>
...
<?php 
 if ($loggedIn == 1) { ?>
        <a class="navbar-brand " href="home.php"><h3 class="text-light-blue"><?php echo $config['appName']; ?></h3></a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">   
        <li class="nav-item <?=echoActiveClassIfRequestMatches("home");?>">
          <a class="nav-link" href="home.php">Home<span class="sr-only">(current)</span></a>
        </li>

        <li class="nav-item <?=echoActiveClassIfRequestMatches("profile");?>">
          <a class="nav-link" href="profile.php">View Profile</a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-danger" href="index.php?logout=true">Sign Out</a>
        </li>
